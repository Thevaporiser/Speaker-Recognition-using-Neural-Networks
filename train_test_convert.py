...
path = '/Users/priyanshringe/Documents/College_Stuff/DATASETS/minor_dataset/data/'
saveImg = '/Users/priyanshringe/Documents/College_stuff/DATASETS/minor_dataset/data/TEST_IMAGES' #change TRAIN_IMAGES to TEST_IMAGES
...
Data = pd.read_csv("/Users/priyanshringe/Documents/College_Stuff/DATASETS/minor_dataset/test_data.csv", dtype = {"dialect_region": str, "speaker_id": str, "path_from_data_dir": str,"filename": str, "is_audio": bool}, nrows=8400, usecols =['dialect_region','speaker_id','filename','path_from_data_dir','is_audio'])
...
for i in range(len(imgfileArray)):
    im.append(imgfileArray[i][:-4] + '.png')
